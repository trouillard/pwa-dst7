...
var DstComponent = /** @class */ (function () {
    ...
    DstComponent.prototype.ngOnInit = function () {
        ...
        this.dateReferenceDST = new _zonedstdata__WEBPACK_IMPORTED_MODULE_2__["DateDST"](null, dateNowArrondi, null);
    ...
    DstComponent.prototype.calculHeureRecherche = function () {
        if ((this.dateReferenceDST.nomZone != undefined) &&
            ...
            var dateTravailDST = new _zonedstdata__WEBPACK_IMPORTED_MODULE_2__["DateDST"](this.dateRechercheDST.nomZone, null, this.dateReferenceDST.dateUTC);
...
module.exports = ".subtitle-design{\r\n    background-color: #b2b5dc;\r\n    height: 25px;\r\n    /* text-align: center; */\r\n    font-size: initial;\r\n    border-radius: 5px;\r\n    padding-left: 5px;\r\n    color: darkblue;\r\n}\r\n\r\n.mat-form-field {   \r\n    width: 30%;\r\n    height: 70px;\r\n}\r\n\r\n.titre {\r\n    height: 40px;\r\n    font-size: 20px; \r\n}\r\n\r\n.buttons {\r\n    margin: 20px 0px;\r\n  }\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ZoneComponent = /** @class */ (function () {
    ...
    /*
      changeZone() {
        ...
        if (!this.readOnly) {
          ...
          this.dateDstOn = this.deformattageDate(this.dateDstOnFormattee);
          this.dateDstOff = this.deformattageDate(this.dateDstOffFormattee);
          this.locale2utc();
        };
    ...
    */
    ...
    ZoneComponent.prototype.formattageDates = function () {
        ...
        this.dateDstOnFormattee = this.formattageDate(this.dateDstOn);
        this.dateDstOffFormattee = this.formattageDate(this.dateDstOff);
    };
    ...
    ZoneComponent.prototype.utc2locale = function () {
        if ((this.zone != undefined) && (this.dateDST.dateUTC != undefined)) {
            ...
            if (this.zone.dst != null) {
                ...
                this.dateDstOn = this.dateon(this.dateDST.dateLocale, this.zone);
                this.dateDstOn = this.heureDSTon(this.dateDstOn, this.zone);
                // CALCUL DE LA DATE OFF
                this.dateDstOff = this.dateoff(this.dateDST.dateLocale, this.zone);
                this.dateDstOff = this.heureDSToff(this.dateDstOff, this.zone);
                // CAS HEMISPHERE NORD
                if (this.dateDstOff > this.dateDstOn) {
                    if ((this.dateDST.dateUTC >= this.dateDstOn) && (this.dateDST.dateUTC < this.dateDstOff)) {
    ...
    ZoneComponent.prototype.locale2utc = function () {
        if ((this.dateDST.nomZone != undefined) && (this.dateDST.dateLocale != undefined)) {
            ...
            if (this.zone.dst != null) {
                ...
                // CAS HEMISPHERE NORD
                if (this.dateDstOff > this.dateDstOn) {
                    if ((this.dateDST.dateLocale >= this.dateDstOn) && (this.dateDST.dateLocale < this.dateDstOff)) {
